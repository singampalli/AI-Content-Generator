...
import TemplateGenerator from "../TemplateEngine/TemplateGenerator";
    ...
    <div className="card border-0 shadow-lg bg-light p-3 rounded">
      <div className="card-body" style={{ padding: "5px" }}>
        ...
        <p className="text-muted mb-4 fs-5">
          Choose a template to kick off your next piece whether it's a
          thoughtful message, a daily update, or an insightful explainer.
        </p>
        <TemplateGenerator />
